...
/*   Updated: 2025/01/26 19:01:43 by akajjou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void draw_floor_ceiling(t_global *global, int ray, int t_pix, int b_pix) // draw the floor and the ceiling
{
	...
	i = b_pix;
	while (i < S_H)
		my_mlx_pixel_put(global, ray, i++, global->data->f_color); // floor
	i = 0;
	while (i < t_pix)
		my_mlx_pixel_put(global, ray, i++, global->data->c_color); // ceiling
}
