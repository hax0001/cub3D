...
/*   Updated: 2025/01/26 21:25:39 by nait-bou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void load_textures(t_global *global) { // taaaaaaaaaaaaaaake
    ...
    global->data->north_tex->img = mlx_xpm_file_to_image(global->mlx_p, "soul_sand.xpm", &global->data->north_tex->width, &global->data->north_tex->height);
    global->data->south_tex->img = mlx_xpm_file_to_image(global->mlx_p, "soul_sand.xpm", &global->data->south_tex->width, &global->data->south_tex->height);
    global->data->east_tex->img = mlx_xpm_file_to_image(global->mlx_p, "soul_sand.xpm", &global->data->east_tex->width, &global->data->east_tex->height);
    global->data->west_tex->img = mlx_xpm_file_to_image(global->mlx_p, "soul_sand.xpm", &global->data->west_tex->width, &global->data->west_tex->height);
